...
class HomeAdapter extends PagedListAdapter<MovieEntity, RecyclerView.ViewHolder> {
    ...
    HomeAdapter(AdapterCallBack adapterCallBack) {
        super(DIFF_CALLBACK);
    ...
    public int getItemCount() {
        return super.getItemCount() + 1 + (hasExtraRow() ? 1 : 0);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof DiscoverViewHolder) {
            onBindDiscoverViewHolder((DiscoverViewHolder) viewHolder, position-1);
        } else
    ...
    private void onBindDiscoverViewHolder(DiscoverViewHolder holder, int position) {
