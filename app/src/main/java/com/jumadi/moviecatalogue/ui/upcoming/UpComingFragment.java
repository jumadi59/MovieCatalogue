package com.jumadi.moviecatalogue.ui.upcoming;
...
public class UpComingFragment extends BaseFragment implements Injectable, MainPage<PagedList<MovieEntity>>, AdapterCallBack {
    ...
    protected void onViewModel() {
        mViewModel = new ViewModelProvider(this, mViewModelFactory).get(UpComingViewModel.class).setApiKey();
